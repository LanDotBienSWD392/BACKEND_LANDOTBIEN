    ...
    public partial class Kaneki : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, new DateTime(2024, 4, 21, 2, 24, 37, 1, DateTimeKind.Local).AddTicks(8629), "Basic", "Basic package", new DateTime(2024, 3, 22, 2, 24, 37, 1, DateTimeKind.Local).AddTicks(8611), true },
                    { 2L, new DateTime(2024, 4, 21, 2, 24, 37, 1, DateTimeKind.Local).AddTicks(8638), "Premium", "Premium package", new DateTime(2024, 3, 22, 2, 24, 37, 1, DateTimeKind.Local).AddTicks(8638), true }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, "Admin Address", new DateTime(2024, 3, 22, 2, 24, 37, 2, DateTimeKind.Local).AddTicks(4491), "admin@example.com", "Male", "123456789", null, "Admin", 1L, "c7ad44cbad762a5da0a452f9e854fdc1e0e7a52a38015f23f3eab1d80b931dd472634dfac71cd34ebc35d16ab7fb8a90c81f975113d6c7538dc69dd8de9077ec", 1L, "123456789", new DateTime(2024, 3, 22, 2, 24, 37, 2, DateTimeKind.Local).AddTicks(4500), true, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, new DateTime(2024, 3, 22, 2, 24, 37, 2, DateTimeKind.Local).AddTicks(4720), "SPX00000000001", 0L, 1, 100.0, 1L },
                    { 2L, new DateTime(2024, 3, 22, 2, 24, 37, 2, DateTimeKind.Local).AddTicks(4723), "SPX00000000002", 0L, 2, 100.0, 1L },
                    { 3L, new DateTime(2024, 3, 22, 2, 24, 37, 2, DateTimeKind.Local).AddTicks(4725), "SPX00000000003", 0L, 3, 100.0, 1L },
                    { 4L, new DateTime(2024, 3, 22, 2, 24, 37, 2, DateTimeKind.Local).AddTicks(4726), "SPX00000000004", 0L, 4, 100.0, 1L }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, new DateTime(2024, 3, 29, 2, 24, 37, 2, DateTimeKind.Local).AddTicks(4668), "Auction 1", 50.0, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "1", 1L, new DateTime(2024, 3, 22, 2, 24, 37, 2, DateTimeKind.Local).AddTicks(4667), 0 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, 1L, 60.0, new DateTime(2024, 3, 22, 2, 24, 37, 2, DateTimeKind.Local).AddTicks(4812), 1L });

            migrationBuilder.InsertData(
                table: "RoomRegistrations",
                columns: new[] { "id", "auction_id", "register_time", "status", "user_id" },
                values: new object[] { 1L, 1L, new DateTime(2024, 3, 22, 2, 24, 37, 2, DateTimeKind.Local).AddTicks(4701), 2, 1L });
