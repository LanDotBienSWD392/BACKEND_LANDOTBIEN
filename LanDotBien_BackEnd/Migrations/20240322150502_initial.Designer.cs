...
namespace LanDotBien_BackEnd.Migrations
{
    ...
    [Migration("20240322150502_initial")]
            ...
            modelBuilder.Entity("LanVar.Core.Entity.Auction", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1L,
                            auctionDay = new DateTime(2024, 3, 29, 22, 5, 1, 679, DateTimeKind.Local).AddTicks(5880),
                            auction_Name = "Auction 1",
                            deposit_Money = 50.0,
                            endDay = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            password = "1",
                            product_id = 1L,
                            startDay = new DateTime(2024, 3, 22, 22, 5, 1, 679, DateTimeKind.Local).AddTicks(5880),
                            status = 0
                        });
                });
            ...
            modelBuilder.Entity("LanVar.Core.Entity.Bid", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            auction_id = 1L,
                            bid = 60.0,
                            bid_time = new DateTime(2024, 3, 22, 22, 5, 1, 679, DateTimeKind.Local).AddTicks(6060),
                            user_id = 1L
                        });
                });
            ...
            modelBuilder.Entity("LanVar.Core.Entity.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1L,
                            date = new DateTime(2024, 3, 22, 22, 5, 1, 679, DateTimeKind.Local).AddTicks(5930),
                            orderCode = "SPX00000000001",
                            orderItem_id = 0L,
                            status = 1,
                            total_Price = 100.0,
                        ...
                        {
                            id = 2L,
                            date = new DateTime(2024, 3, 22, 22, 5, 1, 679, DateTimeKind.Local).AddTicks(5940),
                        ...
                        {
                            id = 4L,
                            date = new DateTime(2024, 3, 22, 22, 5, 1, 679, DateTimeKind.Local).AddTicks(5950),
            ...
            modelBuilder.Entity("LanVar.Core.Entity.RoomRegistrations", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id = 1L,
                            auction_id = 1L,
                            register_time = new DateTime(2024, 3, 22, 22, 5, 1, 679, DateTimeKind.Local).AddTicks(5910),
                            status = 2,
                            user_id = 1L
                        });
                });
            ...
            modelBuilder.Entity("LanVar.Core.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            dob = new DateTime(2024, 3, 22, 22, 5, 1, 679, DateTimeKind.Local).AddTicks(5820),
                            ...
                            permission_id = 1L,
                            phone = "123456789",
                            registerDay = new DateTime(2024, 3, 22, 22, 5, 1, 679, DateTimeKind.Local).AddTicks(5820),
                            status = true,
                            username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("LanVar.Core.Entity.User_Package", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1L,
                            endDay = new DateTime(2024, 4, 21, 22, 5, 1, 679, DateTimeKind.Local).AddTicks(4960),
                            package_id = 2L,
                            price = 100000.0,
                            startDay = new DateTime(2024, 3, 22, 22, 5, 1, 679, DateTimeKind.Local).AddTicks(4920),
                            status = 1,
                            user_id = 1L
                        });
                });
